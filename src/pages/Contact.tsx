...
export default function Contact() {
  ...
  return (
    <div className="animate-fade-up max-w-5xl mx-auto px-6 md:px-10 py-14">
      {/* Header */}
      <p className="font-mono text-[10px] text-muted tracking-[1.5px] mb-3">
        CONTACT
      </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-8">
        ...
        <div className="flex flex-col gap-5">
            ...
            return (
              ...
              >
                ...
                >
                  <Icon
                    size={16}
                    className="text-muted group-hover:text-[var(--brand)] transition-colors duration-200"
                  />
                </div>
                ...
                <span className="ml-auto text-muted text-xs opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                  ↗
                </span>
              </a>
            );
          ...
          <div className="bg-gradient-to-br from-accent/[0.08] to-accent-2/[0.08] border border-accent/20 rounded-xl p-5 mt-1">
            <div className="flex items-center gap-2 mb-1.5">
              ...
              <span className="font-cabinet font-extrabold text-[14px]">
        ...
        <div className="bg-bg-2 border border-border rounded-2xl overflow-hidden">
          ...
          <div className="p-6 md:p-8">
            <h3 className="font-cabinet font-extrabold text-[17px] mb-1">
              Send a Message
            </h3>
            ...
            {status === 'success' ? (
              <div className="flex flex-col items-center justify-center py-12 gap-3 text-center">
                ...
                <p className="font-cabinet font-extrabold text-[16px] text-emerald-400">
                  Message Sent!
                </p>
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="font-mono text-[10px] text-muted tracking-[1px] block mb-1.5">
                      NAME *
                    </label>
                    <input
                      name="name"
